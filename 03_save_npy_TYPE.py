...
# Found 8640 images belonging to 11 classes.
...
# Found 2160 images belonging to 11 classes.
...
np.save('_save/_NPY/TYPE_x_train', arr=xy_train[0][0])
np.save('_save/_NPY/TYPE_x_test', arr=xy_test[0][0])
np.save('_save/_NPY/TYPE_y_train', arr=xy_train[0][1])
np.save('_save/_NPY/TYPE_y_test', arr=xy_test[0][1])

# print(xy_train[0][0]) # 
# print(np.unique(xy_train[0][1])) # 
# print(xy_train[0][0].shape) # (12085, 150, 150, 1)
# print(xy_train[0][1].shape) # (12085, 11)

'''
(17240, 150, 150, 3) (2160, 150, 150, 3)
(17240, 11) (2160, 11)
'''