...
np.save('_save/_NPY/TYPE_x_train', arr=x_train)
np.save('_save/_NPY/TYPE_x_test', arr=x_test)
np.save('_save/_NPY/TYPE_y_train', arr=y_train)
np.save('_save/_NPY/TYPE_y_test', arr=y_test)
