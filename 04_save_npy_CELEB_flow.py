...
# Found 8640 images belonging to 45 classes.
...
# Found 2160 images belonging to 45 classes.
...
x_argmented = x_argmented.reshape(x_argmented.shape[0], 150, 150, 1) # 
...
np.save('_save/_NPY/CELEB_x_train', arr=x_train)
np.save('_save/_NPY/CELEB_x_test', arr=x_test)
np.save('_save/_NPY/CELEB_y_train', arr=y_train)
np.save('_save/_NPY/CELEB_y_test', arr=y_test)
